...
class UpdateMemoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Send null to detach.
            'missionary_request_id' => ['sometimes', 'nullable', 'integer', 'exists:missionary_requests,id'],
            // Any media_ids supplied here are appended to the memory. Remove
            // existing attachments with DELETE /media/{id}.
